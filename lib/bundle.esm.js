...
const fnDirective = (el, binding, vnode) => {
    var _a, _b;
    ...
    const rolesRef = RoleCtr$1.getRoles();
    (_b = binding.instance) === null || _b === void 0 ? void 0 : _b.$watch(() => rolesRef, () => {
        var _a;
        (_a = binding.instance) === null || _a === void 0 ? void 0 : _a.$forceUpdate();
    });
    return;
};
